...
CLASSNAMES = ["neutral", "stress"]
CLASS2IDX = {"neutral": 0, "stress": 1}


class StressID(DatasetBase):
    """
    Root expected:
      <root>/BioVid_Video/
          train/ ...
    ...
    def _read_subject_folders(self, dataset_dir: str):
        ...
        if not dataset_dir.exists():
            raise FileNotFoundError(f"StressID not found at: {dataset_dir}")
